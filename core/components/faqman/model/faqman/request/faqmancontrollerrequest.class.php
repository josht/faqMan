 ...
 * @extends modRequest
 */
class faqManControllerRequest extends modRequest {
    public $faqMan = null;
    public $actionVar = 'action';
    public $defaultAction = 'home';

    function __construct(faqMan &$faqMan) {
        parent :: __construct($faqMan->modx);
        $this->faqMan =& $faqMan;
    }
    ...
    private function _respond() {
        ...
        $viewHeader = include $this->faqMan->config['corePath'].'controllers/mgr/header.php';

        $f = $this->faqMan->config['corePath'].'controllers/mgr/'.$this->action.'.php';
        if (file_exists($f)) {
