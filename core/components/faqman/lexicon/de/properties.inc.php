 ...
 */
/**
 * Properties German Lexicon Entries for faqMan
 * @translation by Anselm Hannemann (http://www.anselm-hannemann.de)
 * @translation-date: 2011-02-02
 * @package faqman
 * @subpackage lexicon
 */
$_lang['prop_faqman.limit_desc'] = 'Anzahl an FAQ-Einträgen pro Seite.';
$_lang['prop_faqman.outputseparator_desc'] = 'String, um die Zeilen zu trennen.';
