...
class FaqmanSetManagerController extends \modExtraManagerController {
    public $faqman;
    private $setid = false;
    ...
    public function loadCustomCssJs() {
        ...
        $this->addHtml('<script>Ext.onReady(function() { MODx.load({xtype: "faqman-page-set", setid:"' . $this->setid . '"}) })</script>');
    }
